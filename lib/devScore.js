...
function compute({ tasks = [], analytics = {}, reviews = [], lastActivityMs = null, now = Date.now(), skip = [] } = {}) {
  const raw = {
...
module.exports = { compute, WEIGHTS, LABELS, confidence, CONFIDENCE_K, estimateTaskScore, lateTaskScore, timeLogging, isReviewOrDone, estimateAccuracy, onTime, codeQuality, reworkFree, completion, activity };
