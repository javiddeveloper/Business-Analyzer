...
function compute({ tasks = [], analytics = {}, reviews = [], now = Date.now(), skip = [], ratings = null, sentryBlame = null } = {}) {
...
module.exports = { compute, mrSize, WEIGHTS, LABELS, confidence, CONFIDENCE_K, estimateTaskScore, lateTaskScore, timeLogging, isReviewOrDone, estimateAccuracy, onTime, codeQuality, reworkFree, completion, dedupeReviews, findingDensity, reviewQualityScore, QUALITY_HALF_LIFE, sentryReliability, blameWeight };
