...
const HTTP_ENGINES = {
  'openai-compatible': { label: 'GapGPT', keyEnv: 'AI_API_KEY', baseEnv: 'AI_BASE_URL', baseDefault: 'https://api.gapgpt.app/v1', modelEnv: 'AI_MODEL', modelDefault: 'gpt-4o-mini' },
  '9router': { label: '9Router', keyEnv: 'NINEROUTER_API_KEY', baseEnv: 'NINEROUTER_BASE_URL', baseDefault: 'http://localhost:20128/v1', modelEnv: 'NINEROUTER_MODEL', modelDefault: 'combo' },
};
...
module.exports = { callModel, listModels, listEngines, engineStatus, testEngine, pickFallbackEngine, listReadyEngines, isQuotaError, secret, HTTP_ENGINES, ENGINES };
