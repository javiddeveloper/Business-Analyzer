...
const SCHEMA = [
  ...
  { key: 'WORKING_DAYS', group: 'تقویم کاری', secret: false,
    hint: 'روزهای کاری هفته، با کاما جدا — مثلاً شنبه,یکشنبه,دوشنبه,سه‌شنبه,چهارشنبه. خالی یعنی پیش‌فرض تعطیلات رسمی ایران (پنجشنبه و جمعه تعطیل) در نظر گرفته می‌شود.' },
